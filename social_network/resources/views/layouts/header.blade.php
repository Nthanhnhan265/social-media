...
<body>
    <div id="myModal" class="share_modal" style="display:none">
        ...
        <div class="share_modal-content">
            ...
            <h2>Chọn Chế Độ Chia Sẻ Bài Viết</h2>
            <form action="{{ route('share.store') }}" method="POST">
                ...
                <div class="share-option">
                    ...
                    <label for="onlyMe">Chỉ với mình
                        tôi</label>
                </div>
                <div class="share-option">
                    <input type="radio" id="everyone" name="shareOption" value="1">
                    <label for="everyone">Với mọi
                        người</label>
                </div>
     ...
     <ul>
      ...
      <li><a href="{{ url('widgets') }}" title="">Widgts</a></li>
                ...
                <ul class="setting-area">
                    ...
                    <li><a href="{{ url('newsfeed') }}" title="Home" data-ripple=""><i class="ti-home"></i></a>
                    </li>
                    <li>

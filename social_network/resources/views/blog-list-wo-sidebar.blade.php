								...
								<div class="l-post">
									<figure>
										...
										<ul class="blg-socials">
											<li><a href="#" title="" class="facebook"><i class="fa fa-facebook"></i></a>
											</li>
											<li><a href="#" title="" class="twitter"><i class="fa fa-twitter"></i></a>
											</li>
											<li><a href="#" title="" class="pinterest"><i
									...
									<div class="l-post-meta">
										...
										<p>
											by imporving the physical layout of hospitals and medical facilities we can
											inhence and increase safety macnisum..
										</p>
										<div class="g-post-ranking">
											<a class="likes" href="#" title=""><i class="fa fa-heart-o"></i>10 likes</a>
											<a class="coments" href="#" title=""><i class="fa fa-comment-o"></i>5
												comments</a>
										</div>

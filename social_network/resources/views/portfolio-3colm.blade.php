						...
						<div class="row masonry">	
									<div class="hand col-lg-4 col-sm-6">
										<div class="portfolio-box">
											...
											<div class="overlinks">
												<h4><a href="{{ url('portfolio-detail') }}" title="">Gents Shoes</a></h4>
												<ul class="cate">
									...
									<div class="jewl col-lg-4 col-sm-6">
										<div class="portfolio-box">
											...
											<div class="overlinks">
												<h4><a href="{{ url('portfolio-detail') }}" title="">Hand Bag</a></h4>
												<ul class="cate">
									...
									<div class="accessory col-lg-4 col-sm-6">
										<div class="portfolio-box">
											...
											<div class="overlinks">
												<h4><a href="{{ url('portfolio-detail') }}" title="">HeadPhone GSound</a></h4>
												<ul class="cate">
													<li><a href="#" title="">accessoires</a></li>
													<li><a href="#" title="">home made</a></li>
													<li><a href="#" title="">clothes</a></li>
									...
									<div class="diy col-lg-4 col-sm-6">
										<div class="portfolio-box">
											...
											<div class="overlinks">
												<h4><a href="{{ url('portfolio-detail') }}" title="">Winter Cap</a></h4>
												<ul class="cate">
													<li><a href="#" title="">accessoires</a></li>
													<li><a href="#" title="">home made</a></li>
													<li><a href="#" title="">clothes</a></li>
									...
									<div class="cloth col-lg-4 col-sm-6">
										<div class="portfolio-box">
											...
											<div class="overlinks">
												<h4><a href="{{ url('portfolio-detail') }}" title="">Men's Watch</a></h4>
												<ul class="cate">
													<li><a href="#" title="">accessoires</a></li>
													<li><a href="#" title="">home made</a></li>
													<li><a href="#" title="">clothes</a></li>
									...
									<div class="accessory col-lg-4 col-sm-6">
										<div class="portfolio-box">
											...
											<div class="overlinks">
												<h4><a href="{{ url('portfolio-detail') }}" title="">Stylo Shoes</a></h4>
												<ul class="cate">
													<li><a href="#" title="">accessoires</a></li>
													<li><a href="#" title="">home made</a></li>
													<li><a href="#" title="">clothes</a></li>
									...
									<div class="jewl col-lg-4 col-sm-6">
										<div class="portfolio-box">
											...
											<div class="overlinks">
												<h4><a href="{{ url('portfolio-detail') }}" title="">JBL Headphone</a></h4>
												<ul class="cate">
													<li><a href="#" title="">accessoires</a></li>
													<li><a href="#" title="">home made</a></li>
													<li><a href="#" title="">clothes</a></li>
									...
									<div class="jewl col-lg-4 col-sm-6">
										<div class="portfolio-box">
											<img src="images/resources/folio-detail2.jpg" alt="">
											<div class="overlinks">
												<h4><a href="{{ url('portfolio-detail') }}" title="">JBL bag</a></h4>
												<ul class="cate">
													<li><a href="#" title="">accessoires</a></li>
													<li><a href="#" title="">home made</a></li>
													<li><a href="#" title="">clothes</a></li>

									...
									<div class="widget stick-widget">
										...
										<ul class="naves">
											...
											<li>
												...
												<a title="" href="{{ url('inbox') }}">Inbox</a>
											</li>
											<li>
												<i class="ti-files"></i>
												<a title="" href="{{ url('page') }}">My pages</a>
											</li>
											<li>
												<i class="ti-user"></i>
												<a title="" href="{{ url('friends-list') }}">friends</a>
											</li>
											<li>
												<i class="ti-image"></i>
												<a title="" href="{{ url('images') }}">images</a>
											</li>
											<li>
												<i class="ti-video-camera"></i>
												<a title="" href="{{ url('videos') }}">videos</a>
											</li>
											<li>
												<i class="ti-comments-smiley"></i>
												<a title="" href="{{ url('messages') }}inbox">Messages</a>
											</li>

			...
			<div class="col-lg-10 col-sm-9">
				<div class="timeline-info">
					<ul>
						...
						<li>
							<a class="{{Request::is('time-line/user-profile/'.$user->user_id) ? 'active' : ''}}" href="{{ url('time-line/user-profile/' . $user->user_id) }}" title=""
							...
							@if(auth()->check() && $user->user_id == auth()->user()->user_id)
								<a class="{{Request::is('about' . '/user-profile/'.$user->user_id) ? 'active' : ''}}" href="{{ url('about' . '/user-profile/' . $id) }}" title=""
									data-ripple="">about</a>

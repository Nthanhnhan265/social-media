									...
									<div class="widget stick-widget">
										...
										<ul class="naves">
											...
											<li>
												...
												<a title="" href="inbox">Inbox</a>
											</li>
											<li>
												<i class="ti-files"></i>
												<a title="" href="page">My pages</a>
											</li>
											<li>
												<i class="ti-user"></i>
												<a title="" href="friends-list">friends</a>
											</li>
											<li>
												<i class="ti-image"></i>
												<a title="" href="images">images</a>
											</li>
											<li>
												<i class="ti-video-camera"></i>
												<a title="" href="videos">videos</a>
											</li>
											<li>
												<i class="ti-comments-smiley"></i>
												<a title="" href="inbox">Messages</a>
											</li>

					...
					<div class="col-lg-12">
						<div class="page-eror">
							...
							<div class="error-meta">
								...
								<a href="{{ url ('index-2') }}" title="" data-ripple="">Go Back Home</a>
							</div>
						</div>
					</div>
				</div>
...
<li><a href="{{ url('sitemap') }}" title="">Sitemap</a></li>
				...
				<div class="col-lg-2 col-md-4">
					<div class="widget">
						...
						<ul class="list-style">
						<li><a href="{{ url('leasing') }}" title="">leasing</a></li>
<li><a href="{{ url('submit-route') }}" title="">submit route</a></li>
<li><a href="{{ url('how-does-it-work') }}" title="">how does it work?</a></li>
<li><a href="{{ url('agent-listings') }}" title="">agent listings</a></li>
<li><a href="{{ url('view-all') }}" title="">view All</a></li>

				...
				<div class="row">
					<div class="col-lg-12">
						<div class="top-banner">
							<h1>Our Shop Masonry</h1>
							<nav class="breadcrumb">
							  <a class="breadcrumb-item" href="{{ url('index-2') }}">Home</a>
							  <span class="breadcrumb-item active">Shop Masonry</span>
							</nav>
						</div>
					</div>
				</div>
						...
						<div class="shop-page">
							...
							<div class="row masonry">
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										<figure>
											...
											<img src="images/resources/shop-masn1.jpg" alt="">
											<ul class="cart-optionz">
												<li><a href="#" title="Add Cart" data-toggle="tooltip"><i class="ti-shopping-cart"></i></a></li>
												<li><a href="#" title="Quick Shop" data-toggle="tooltip"><i class="ti-eye"></i></a></li>
												<li><a href="#" title="Wishlist" data-toggle="tooltip"><i class="ti-heart"></i></a></li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										<figure>
											...
											<img src="images/resources/shop-masn2.jpg" alt="">
											<ul class="cart-optionz">
												<li><a href="#" title="Add Cart" data-toggle="tooltip"><i class="ti-shopping-cart"></i></a></li>
												<li><a href="#" title="Quick Shop" data-toggle="tooltip"><i class="ti-eye"></i></a></li>
												<li><a href="#" title="Wishlist" data-toggle="tooltip"><i class="ti-heart"></i></a></li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										<figure>
											<img src="images/resources/shop5.jpg" alt="">
											<ul class="cart-optionz">
												<li><a href="#" title="Add Cart" data-toggle="tooltip"><i class="ti-shopping-cart"></i></a></li>
												<li><a href="#" title="Quick Shop" data-toggle="tooltip"><i class="ti-eye"></i></a></li>
												<li><a href="#" title="Wishlist" data-toggle="tooltip"><i class="ti-heart"></i></a></li>
										...
										<div class="product-name">
											<h5><a href="#" title="">Ladies Fancy Shoes</a></h5>
											<ul class="starz">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										<figure>
											<img src="images/resources/shop6.jpg" alt="">
											<ul class="cart-optionz">
												<li><a href="#" title="Add Cart" data-toggle="tooltip"><i class="ti-shopping-cart"></i></a></li>
												<li><a href="#" title="Quick Shop" data-toggle="tooltip"><i class="ti-eye"></i></a></li>
												<li><a href="#" title="Wishlist" data-toggle="tooltip"><i class="ti-heart"></i></a></li>
										...
										<div class="product-name">
											<h5><a href="#" title="">New Trending Hat</a></h5>
											<ul class="starz">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										<figure>
											<span class="sale">sale</span>
											<img src="images/resources/shop7.jpg" alt="">
											<ul class="cart-optionz">
												<li><a href="#" title="Add Cart" data-toggle="tooltip"><i class="ti-shopping-cart"></i></a></li>
												<li><a href="#" title="Quick Shop" data-toggle="tooltip"><i class="ti-eye"></i></a></li>
												<li><a href="#" title="Wishlist" data-toggle="tooltip"><i class="ti-heart"></i></a></li>
										...
										<div class="product-name">
											<h5><a href="#" title="">Travel bag</a></h5>
											<ul class="starz">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										<figure>
											...
											<img src="images/resources/shop8.jpg" alt="">
											<ul class="cart-optionz">
												<li><a href="#" title="Add Cart" data-toggle="tooltip"><i class="ti-shopping-cart"></i></a></li>
												<li><a href="#" title="Quick Shop" data-toggle="tooltip"><i class="ti-eye"></i></a></li>
												<li><a href="#" title="Wishlist" data-toggle="tooltip"><i class="ti-heart"></i></a></li>
										...
										<div class="product-name">
											<h5><a href="#" title="">Side alaram</a></h5>
											<ul class="starz">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										...
										<div class="product-name">
											<h5><a href="#" title="">Men's watch</a></h5>
											<ul class="starz">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										<figure>
											<img src="images/resources/shop-masn3.jpg" alt="">
											<ul class="cart-optionz">
												<li><a href="#" title="Add Cart" data-toggle="tooltip"><i class="ti-shopping-cart"></i></a></li>
												<li><a href="#" title="Quick Shop" data-toggle="tooltip"><i class="ti-eye"></i></a></li>
												<li><a href="#" title="Wishlist" data-toggle="tooltip"><i class="ti-heart"></i></a></li>
										...
										<div class="product-name">
											<h5><a href="#" title="">New Leather Shoes</a></h5>
											<ul class="starz">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="product-box">
										...
										<div class="product-name">
											<h5><a href="#" title="">headphone jbond</a></h5>
											<ul class="starz">
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
												<li><i class="fa fa-star"></i></li>
